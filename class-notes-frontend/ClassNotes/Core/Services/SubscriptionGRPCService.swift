...
struct UsageStats {
    ...
    init(from proto: Classnotes_V1_GetUsageStatsResponse) {
        ...
        self.monthlyLimitLessons = proto.hasMonthlyLimitLessons ? Int(proto.monthlyLimitLessons) : nil
        self.monthlyLimitStorageMB = proto.hasMonthlyLimitStorageMb ? Int(proto.monthlyLimitStorageMb) : nil
    }
